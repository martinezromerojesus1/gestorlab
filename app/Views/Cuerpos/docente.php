...
<body>
    ...
    <h1>Bienvenido, estás en la vista de 'docente'</h1>
  <div class="nav">
        <div class="menu"></div>
        <ul>
            <li class="list">
                <a href="<?= base_url('reservaLabDocente'); ?>" style="--clr:#4D4DFF;">
                    <span class="icon"><ion-icon name='today'></ion-icon></span>
                    <span class="txt">Reservar un laboratorio</span>
                </a>
            </li>
            <li class="list">
                <a href="<?= base_url('reservaEqDocente'); ?>" style="--clr:#015655;">
                    <span class="icon"><ion-icon name='today'></ion-icon></span>
                    <span class="txt">Reservar un Equipo</span>
                </a>
            </li>
            <li class="list">
                <a href="<?= base_url('docenteNotis'); ?>" style="--clr:#0015ff;">
