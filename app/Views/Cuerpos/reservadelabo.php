...
<body>
      <form method="post" class="search-bar" action="<?= base_url('laboratorio/buscaar') ?>">
        <label for="nombrelabo">Buscar laboratorio por nombre:</label>
        <input type="text" name="nombrelabo">
      ...
      <h4>Lista de los laboratorios</h4>
    <table class="approval">
        ...
        <?php foreach ($datos as $item): ?>
            <tr>
                ...
                <td><?= $item['nombrelabo'] ?></td>
                <td><?= $item['ubicacion'] ?></td>
                <td><?= $item['salon'] ?></td>

                <td>
                    <form action="<?php echo base_url('Solicitar_dato/'.$item['idlaboratorio']); ?>" method="post">
