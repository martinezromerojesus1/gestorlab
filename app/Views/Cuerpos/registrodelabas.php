        ...
        <div class="row justify-content-center" style="margin:20px;">
            <div class="col-lg-6 col-md-8 login-box">
                ...
                <div class="col-lg-12 login-form">
                    <form action="<?= base_url('guardar_laboratorios')?>" method="post">
                        ...
                        <div class="form-group">
                            <label class="form-control-label" for="nombre">Ubicacion del laboratorio::</label>
                            <select id="tipo" name="tipo">
                                <option value='JCH1'>JCH1</option>
                                <option value='JCH2'>JCH2</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label class="form-control-label">Número de salón:</label>
                            <input type="text" id="salon" name="salon" required class="form-control">
                        </div>
