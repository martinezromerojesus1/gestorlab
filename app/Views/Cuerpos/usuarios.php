...
<body>
    ...
    <form method="post" class="search-bar" action="<?= base_url('Usuario/buscar') ?>">
  ...
  <div class="nav">
        ...
        <ul>
            <li class="list active">
                <a href="<?= base_url('alta_usuario'); ?>" style="--clr:#07eead;">
                    <span class="icon"><ion-icon name="person"></ion-icon></span>
                    <span class="txt">Crea un usuario</span>
                </a>
            </li>
            <li class="list">
                <a href="<?= base_url('reservadelabo'); ?>" style="--clr:#4D4DFF;">
                    <span class="icon"><ion-icon name='today'></ion-icon></span>
                    <span class="txt">Reservar un laboratorio</span>
                </a>
            </li>
            <li class="list">
                <a href="<?= base_url('reservadeequipo'); ?>" style="--clr:#015655;">
                    <span class="icon"><ion-icon name='today'></ion-icon></span>
                    <span class="txt">Reservar un Equipo</span>
                </a>
            </li>
            <li class="list">
                <a href="<?= base_url('registarequipos'); ?>" style="--clr:#043a53;">
                    <span class="icon"><ion-icon name="create"></ion-icon></span>
                    <span class="txt">Registar un Equipo</span>
                </a>
            </li>
            <li class="list">
                <a href="<?= base_url('registrodelabas'); ?>" style="--clr:#5145d4;">
                    <span class="icon"><ion-icon name="create"></ion-icon></span>
                    <span class="txt">Registar un laboratorio</span>
                </a>
            </li>
            <li class="list">
                <a href="<?= base_url('Solicitudes'); ?>" style="--clr:#0015ff;">
  ...
  <table class="approval">
    ...
    <tr>
      ...
      <td><a href="<?=base_url('borrar/'.$dato['idusuario']);?>"><i class="fa-solid fa-trash-can"></i></a></td>
       <td><a href="<?=base_url('editar/'.$dato['idusuario']);?>"><i class="fa-solid fa-pencil"></i></a></td>   
    </tr>
       </tbody>
    <?php endforeach; ?>
    </table>
