        ...
        <div class="row justify-content-center" style="margin:20px;">
            <div class="col-lg-6 col-md-8 login-box">
                ...
                <div class="col-lg-12 login-form">
                    <form action="<?= base_url('reserva_laboratorios')?>" method="post" >
                    <div class="form-group">
                            <input type="hidden" class="form-control" value="<?= $datos['idlaboratorio'];?>" name="id" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="form-control-label" >Nombre de laboratorio:</label>
                            <input type="text" id="laboratorio" value="<?= $datos['nombrelabo'];?>" name="laboratorio" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="form-control-label" >Ubicacion:</label>
                            <input type="text" id="ubicacion" value="<?= $datos['ubicacion'];?>" name="ubicacion" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="form-control-label" >Salon:</label>
                            <input type="text" id="salon" value="<?= $datos['salon'];?>" name="salon" required class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="submit">
                            <a href="<?= base_url('reservadelabo'); ?>" type="submit" class="btn btn-outline-primary">Regresar al inicio</a>
                        </div>
                </div>
                </form>
            </div>
